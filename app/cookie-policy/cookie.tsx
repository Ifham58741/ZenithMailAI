...
const CookiePolicy: React.FC = () => {
  return (
    <div className="tiptap ProseMirror prose max-w-none focus:outline-none">
      ...
      <h2>
        <strong>Effective Date: August 29, 2024</strong>
      </h2>
      <p>
        ZenithMailAI (&quotZenithMailAI,&quot; &quot;we,&quot; &quot;us,&quot;
        or &quot;our&quot;) is committed to protecting your privacy and ensuring
        you have a positive experience on our website, applications, and while
        using our services. This Cookie Policy explains how we use cookies and
        similar technologies to recognize you when you visit our platforms. It
      ...
      <p>
        Cookies set by the website owner (in this case, ZenithMailAI) are called
      ...
      <ul>
        <li>
          <p>
            ...
            our Websites and to use some of its features, such as access to
            secure areas.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            understand how our Websites are being used or how effective our
            marketing campaigns are, or to help us customize our Websites for
            you.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            to enable you to share pages and content that you find interesting
            on our Websites through third party social networking and other
      ...
      <p>
        ...
        technologies, please email us at<strong> ZenithMailAI@gmail.com</strong>
      </p>
      <p>
        This Cookie Policy is part of our broader Privacy Policy and should be
        read in conjunction with it. By using our services, you acknowledge you
        have read and understood this Cookie Policy as well as our Privacy
