...
const TermsServices = () => {
  return (
    <div className="tiptap ProseMirror prose max-w-none focus:outline-none">
      ...
      <p>
        We are ZenithMailAI ( &quot;<strong>Company</strong>,&quot; &quot;
        <strong>we</strong>,&quot; &quot;<strong>us</strong>,&quot; &quot;
        <strong>our</strong>&quot; ) , a company  at Coimbatore , TN .
      </p>
      <p>
        We operate the website <strong>https://www.ZenithMailAI.com</strong>
      ...
      <p>
        You can contact us by phone at +919263026139 , email at
        ZenithMailAI@gmail.com , or by mail to Coimbatore , Tamil Nadu ,
        India .
      </p>
      <p>
        <br className="ProseMirror-trailingBreak" />
      ...
      <p>
        ...
        <strong>you</strong>&quot; ), and ZenithMailAI , concerning your access
      ...
      <p>
        ...
        upon posting or notifying you by ZenithMailAI@gmail.com, as stated in
      ...
      <p>
        ...
        address your request to: ZenithMailAI@gmail.com. If we ever grant you
      ...
      <p>
        <strong>Phone: +919263026139</strong>
      </p>
      <p>
        <strong>ZenithMailAI@gmail.com</strong>
      </p>
    </div>
  );
};
